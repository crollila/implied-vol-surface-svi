...
2026-09-22 20:05 UTC. Every figure in this document comes from that run;
...
| Underlying | **SPY** |
| Spot | 773.44 |
| As of | 2026-09-22 20:05 UTC |
| Risk-free rate | 4.00% (continuous) |
| Forward source | put_call_parity (12) |
| Price source | 1,321 bid/ask mid (99%), 10 last trade (1%) |
| Expiry slices fitted | **12** (8–486 days) |
| Clean surface points | **1,331** |
| Median fit RMSE | **8.7 vol bps** |

### Where the prices came from

Most points come from live two-sided markets (1,321 of 1,331), with the last-trade fallback filling in strikes that were momentarily unquoted.

### From raw chain to clean surface

The listed chain contained **9,667** contracts. Filtering leaves
**1,331** usable points (13.8%):

| Stage | Contracts remaining | Why |
|---|---:|---|
| Raw chain | 9,667 | every listed contract |
| Valid strike | 9,667 | drop malformed rows |
| Has a usable price | 8,385 | live two-sided mid, else a same-session last trade above the minimum premium |
| Inside the expiry window | 6,611 | 7–550 days |
| Out-of-the-money, monotone in strike | 3,454 | keep the OTM side; discard prints that break monotonicity of price in strike |
| Implied vol solved | 3,454 | Brent/Newton inversion converged |
| Plausible vol level | 3,454 | 1% <= IV <= 300% |
| Inside the hard moneyness cap | 3,368 | \|k\| within the absolute limit |
| Non-negligible vega | 3,368 | price actually responds to volatility |
| Within 4 standard deviations | 2,668 | maturity-scaled wing cutoff |
| Not a local outlier | 2,638 | robust distance from the local smile |
| In one of the fitted slices | 1,331 | slice has enough points on both wings, and is one of the 12 expiries kept from the 21 that qualified |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|:--:|
| 2026-09-30 | 8 | 80 | -0.00078 | 0.0173 | -0.303 | -0.0102 | 0.0588 | 9.61% | 18.5 | yes |
| 2026-10-02 | 10 | 96 | -0.00115 | 0.0210 | -0.286 | -0.0099 | 0.0708 | 10.36% | 16.7 | yes |
| 2026-10-16 | 24 | 113 | -0.00353 | 0.0379 | -0.225 | -0.0001 | 0.1150 | 11.28% | 8.3 | yes |
| 2026-10-23 | 31 | 122 | -0.00511 | 0.0452 | -0.189 | +0.0085 | 0.1365 | 11.61% | 8.8 | yes |
| 2026-11-20 | 59 | 57 | -0.01336 | 0.0737 | -0.197 | +0.0183 | 0.2148 | 13.16% | 6.7 | yes |
| 2026-12-18 | 87 | 73 | -0.01587 | 0.0865 | -0.227 | +0.0247 | 0.2285 | 13.72% | 7.0 | yes |
| 2027-01-15 | 115 | 87 | -0.02191 | 0.1026 | -0.205 | +0.0386 | 0.2631 | 14.00% | 6.4 | yes |
| 2027-02-26 | 157 | 127 | -0.04531 | 0.1434 | -0.073 | +0.0946 | 0.3611 | 14.63% | 8.7 | yes |
| 2027-03-31 | 190 | 131 | -0.05052 | 0.1498 | -0.147 | +0.0806 | 0.3959 | 15.03% | 4.3 | yes |
| 2027-06-17 | 268 | 129 | -0.08648 | 0.1901 | -0.131 | +0.1189 | 0.5244 | 15.96% | 13.2 | yes |
| 2027-09-17 | 360 | 151 | -0.10349 | 0.2123 | -0.111 | +0.1667 | 0.5741 | 16.66% | 21.7 | yes |
| 2028-01-21 | 486 | 165 | -0.12277 | 0.2383 | -0.071 | +0.2275 | 0.6237 | 17.18% | 24.1 | yes |

Full precision, plus wing slopes and diagnostics, is in
[`outputs/svi_params.csv`](outputs/svi_params.csv).

**Fit quality.** Median RMSE across slices is **8.7 vol basis points**
(mean 12.0, worst 24.1). For context, the bid/ask spread on a
...
SVI: it compresses 1,331 quotes into 60 numbers with almost no
information loss.
...
Every one of the 12 fitted slices slopes downward: a 10% out-of-the-money put is quoted between 4.2 and 7.8 vol points above the 10% out-of-the-money call on the same expiry. This is the persistent equity-index downside skew, and it is the single largest departure from Black-Scholes on the whole surface.

| Expiry | Days | ATM IV | Skew: IV(−10%) − IV(+10%) | ATM total variance |
|---|---:|---:|---:|---:|
| 2026-09-30 | 8 | 9.61% | +7.44 | 0.00020 |
| 2026-10-02 | 10 | 10.36% | +7.14 | 0.00029 |
| 2026-10-16 | 24 | 11.28% | +7.14 | 0.00084 |
| 2026-10-23 | 31 | 11.61% | +7.42 | 0.00115 |
| 2026-11-20 | 59 | 13.16% | +7.76 | 0.00280 |
| 2026-12-18 | 87 | 13.72% | +7.50 | 0.00449 |
| 2027-01-15 | 115 | 14.00% | +7.14 | 0.00618 |
| 2027-02-26 | 157 | 14.63% | +6.80 | 0.00921 |
| 2027-03-31 | 190 | 15.03% | +6.20 | 0.01176 |
| 2027-06-17 | 268 | 15.96% | +5.50 | 0.01870 |
| 2027-09-17 | 360 | 16.66% | +4.90 | 0.02736 |
| 2028-01-21 | 486 | 17.18% | +4.22 | 0.03928 |
...
**+4.22** to **+7.76** vol points and is **falling** with maturity.
...
**A note on reading `rho`.** It is tempting to treat `rho` alone as the skew, and on this surface that would mislead: the fitted `rho` averages only -0.18, yet the smiles are steeply downward-sloping. Raw SVI has two ways to tilt a slice over the quoted range — rotate it with `rho`, or slide its vertex sideways with `m` — and here the fit mostly used `m` (mean +0.063, i.e. the minimum of the smile sits *above* the forward, leaving the traded strikes on the downward-sloping left branch). The two parameters are only weakly separated by data confined to one side of the vertex, which is exactly why the skew is measured here as an IV difference between two strikes rather than read off a parameter. The curve is well determined even where the parameters are not.
...
ATM implied vol runs from **9.61%** at 8 days to
**17.18%** at 486 days, and is **rising** across the term
structure.

ATM **total variance** `w = σ²T` rises monotonically from 0.00020
to 0.03928. That monotonicity is not cosmetic — it is
...
* **Across strikes**, at the 8-day expiry, fitted IV moves
  7.44 vol points between k = −0.10 and k = +0.10. At
  486 days it moves 4.22.
* **Across maturities**, ATM vol moves 7.56 vol points from the
  front slice to the back.
* **Total range** of fitted ATM vol across the surface: 9.61% to
  17.18%.
...
Take the 190-day expiry (2027-03-31) and price a put struck at 90% of the
forward — a standard portfolio hedge:

| | Volatility | Put price |
|---|---:|---:|
| Black-Scholes with the ATM vol | 15.03% | 6.99 |
| Fitted SVI vol at that strike | 19.15% | 12.98 |
| **Difference** | **+4.12 vol pts** | **+5.99 (+85.8%)** |
...
Across all 1,331 points, the model-minus-market residual has mean
**-1.1 vol bps** and standard deviation **14.5 vol bps**; the median
