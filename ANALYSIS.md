...
2026-09-17 20:08 UTC. Every figure in this document comes from that run;
...
| Underlying | **SPY** |
| Spot | 762.70 |
| As of | 2026-09-17 20:08 UTC |
| Risk-free rate | 4.00% (continuous) |
| Forward source | put_call_parity (12) |
| Price source | 1,375 bid/ask mid (100%), 3 last trade (0%) |
| Expiry slices fitted | **12** (8–491 days) |
| Clean surface points | **1,378** |
| Median fit RMSE | **13.0 vol bps** |

### Where the prices came from

Most points come from live two-sided markets (1,375 of 1,378), with the last-trade fallback filling in strikes that were momentarily unquoted.

### From raw chain to clean surface

The listed chain contained **9,562** contracts. Filtering leaves
**1,378** usable points (14.4%):

| Stage | Contracts remaining | Why |
|---|---:|---|
| Raw chain | 9,562 | every listed contract |
| Valid strike | 9,562 | drop malformed rows |
| Has a usable price | 8,353 | live two-sided mid, else a same-session last trade above the minimum premium |
| Inside the expiry window | 6,724 | 7–550 days |
| Out-of-the-money, monotone in strike | 3,662 | keep the OTM side; discard prints that break monotonicity of price in strike |
| Implied vol solved | 3,662 | Brent/Newton inversion converged |
| Plausible vol level | 3,662 | 1% <= IV <= 300% |
| Inside the hard moneyness cap | 3,549 | \|k\| within the absolute limit |
| Non-negligible vega | 3,549 | price actually responds to volatility |
| Within 4 standard deviations | 2,834 | maturity-scaled wing cutoff |
| Not a local outlier | 2,760 | robust distance from the local smile |
| In one of the fitted slices | 1,378 | slice has enough points on both wings, and is one of the 12 expiries kept from the 21 that qualified |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|:--:|
| 2026-09-25 | 8 | 73 | -0.00110 | 0.0193 | -0.038 | +0.0219 | 0.0672 | 11.36% | 21.6 | yes |
| 2026-10-02 | 15 | 101 | -0.00246 | 0.0310 | -0.125 | +0.0158 | 0.0944 | 11.75% | 27.9 | yes |
| 2026-10-16 | 29 | 117 | -0.00572 | 0.0483 | -0.138 | +0.0231 | 0.1386 | 12.39% | 18.7 | yes |
| 2026-10-23 | 36 | 125 | -0.00630 | 0.0543 | -0.041 | +0.0426 | 0.1363 | 12.57% | 10.6 | yes |
| 2026-11-20 | 64 | 60 | -0.01472 | 0.0819 | -0.091 | +0.0533 | 0.2083 | 13.68% | 6.5 | yes |
| 2026-12-18 | 92 | 76 | -0.01952 | 0.0984 | -0.114 | +0.0626 | 0.2345 | 14.19% | 8.3 | yes |
| 2027-01-15 | 120 | 90 | -0.02351 | 0.1100 | -0.140 | +0.0681 | 0.2571 | 14.37% | 10.6 | yes |
| 2027-02-26 | 162 | 130 | -0.03782 | 0.1392 | -0.057 | +0.1117 | 0.3167 | 14.86% | 8.3 | yes |
| 2027-03-31 | 195 | 125 | -0.05227 | 0.1557 | -0.099 | +0.1126 | 0.3885 | 15.25% | 3.4 | yes |
| 2027-06-17 | 273 | 134 | -0.06628 | 0.1767 | -0.137 | +0.1308 | 0.4462 | 15.96% | 15.5 | yes |
| 2027-09-17 | 365 | 163 | -0.09094 | 0.2042 | -0.131 | +0.1667 | 0.5327 | 16.58% | 24.4 | yes |
| 2028-01-21 | 491 | 184 | -0.11344 | 0.2326 | -0.090 | +0.2235 | 0.5956 | 17.07% | 25.7 | yes |
...
(mean 15.1, worst 27.9). For context, the bid/ask spread on a
...
SVI: it compresses 1,378 quotes into 60 numbers with almost no
information loss.
...
Every one of the 12 fitted slices slopes downward: a 10% out-of-the-money put is quoted between 4.4 and 9.2 vol points above the 10% out-of-the-money call on the same expiry. This is the persistent equity-index downside skew, and it is the single largest departure from Black-Scholes on the whole surface.

| Expiry | Days | ATM IV | Skew: IV(−10%) − IV(+10%) | ATM total variance |
|---|---:|---:|---:|---:|
| 2026-09-25 | 8 | 11.36% | +8.18 | 0.00028 |
| 2026-10-02 | 15 | 11.75% | +8.64 | 0.00057 |
| 2026-10-16 | 29 | 12.39% | +9.19 | 0.00122 |
| 2026-10-23 | 36 | 12.57% | +9.14 | 0.00156 |
| 2026-11-20 | 64 | 13.68% | +9.10 | 0.00328 |
| 2026-12-18 | 92 | 14.19% | +8.63 | 0.00507 |
| 2027-01-15 | 120 | 14.37% | +8.08 | 0.00679 |
| 2027-02-26 | 162 | 14.86% | +7.51 | 0.00980 |
| 2027-03-31 | 195 | 15.25% | +6.75 | 0.01243 |
| 2027-06-17 | 273 | 15.96% | +5.94 | 0.01905 |
| 2027-09-17 | 365 | 16.58% | +5.15 | 0.02748 |
| 2028-01-21 | 491 | 17.07% | +4.38 | 0.03918 |
...
**+4.38** to **+9.19** vol points and is **falling** with maturity.
...
**A note on reading `rho`.** It is tempting to treat `rho` alone as the skew, and on this surface that would mislead: the fitted `rho` averages only -0.10, yet the smiles are steeply downward-sloping. Raw SVI has two ways to tilt a slice over the quoted range — rotate it with `rho`, or slide its vertex sideways with `m` — and here the fit mostly used `m` (mean +0.086, i.e. the minimum of the smile sits *above* the forward, leaving the traded strikes on the downward-sloping left branch). The two parameters are only weakly separated by data confined to one side of the vertex, which is exactly why the skew is measured here as an IV difference between two strikes rather than read off a parameter. The curve is well determined even where the parameters are not.
...
ATM implied vol runs from **11.36%** at 8 days to
**17.07%** at 491 days, and is **rising** across the term
structure.

ATM **total variance** `w = σ²T` rises monotonically from 0.00028
to 0.03918. That monotonicity is not cosmetic — it is
...
* **Across strikes**, at the 8-day expiry, fitted IV moves
  8.18 vol points between k = −0.10 and k = +0.10. At
  491 days it moves 4.38.
* **Across maturities**, ATM vol moves 5.71 vol points from the
  front slice to the back.
* **Total range** of fitted ATM vol across the surface: 11.36% to
  17.07%.
...
Take the 195-day expiry (2027-03-31) and price a put struck at 90% of the
forward — a standard portfolio hedge:

| | Volatility | Put price |
|---|---:|---:|
| Black-Scholes with the ATM vol | 15.25% | 7.42 |
| Fitted SVI vol at that strike | 19.56% | 13.79 |
| **Difference** | **+4.30 vol pts** | **+6.37 (+85.9%)** |
...
Across all 1,378 points, the model-minus-market residual has mean
**-2.1 vol bps** and standard deviation **17.9 vol bps**; the median
