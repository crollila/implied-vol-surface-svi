...
2026-09-16 19:57 UTC. Every figure in this document comes from that run;
...
| Underlying | **SPY** |
| Spot | 754.29 |
| As of | 2026-09-16 19:57 UTC |
| Risk-free rate | 4.00% (continuous) |
| Forward source | put_call_parity (12) |
| Price source | 1,677 bid/ask mid (100%), 2 last trade (0%) |
| Expiry slices fitted | **12** (7–492 days) |
| Clean surface points | **1,679** |
| Median fit RMSE | **22.7 vol bps** |

### Where the prices came from

Most points come from live two-sided markets (1,677 of 1,679), with the last-trade fallback filling in strikes that were momentarily unquoted.

### From raw chain to clean surface

The listed chain contained **9,751** contracts. Filtering leaves
**1,679** usable points (17.2%):

| Stage | Contracts remaining | Why |
|---|---:|---|
| Raw chain | 9,751 | every listed contract |
| Valid strike | 9,751 | drop malformed rows |
| Has a usable price | 8,615 | live two-sided mid, else a same-session last trade above the minimum premium |
| Inside the expiry window | 6,994 | 7–550 days |
| Out-of-the-money, monotone in strike | 3,790 | keep the OTM side; discard prints that break monotonicity of price in strike |
| Implied vol solved | 3,790 | Brent/Newton inversion converged |
| Plausible vol level | 3,790 | 1% <= IV <= 300% |
| Inside the hard moneyness cap | 3,680 | \|k\| within the absolute limit |
| Non-negligible vega | 3,680 | price actually responds to volatility |
| Within 4 standard deviations | 2,998 | maturity-scaled wing cutoff |
| Not a local outlier | 2,925 | robust distance from the local smile |
| In one of the fitted slices | 1,679 | slice has enough points on both wings, and is one of the 12 expiries kept from the 23 that qualified |

That attrition is the honest part of the exercise: only 17.2% of the listed chain
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|:--:|
| 2026-09-23 | 7 | 63 | -0.00158 | 0.0188 | -0.524 | -0.0090 | 0.1102 | 14.75% | 27.3 | yes |
| 2026-09-25 | 9 | 74 | -0.00215 | 0.0256 | -0.120 | +0.0296 | 0.0973 | 14.91% | 32.3 | yes |
| 2026-10-02 | 16 | 96 | -0.00308 | 0.0354 | -0.088 | +0.0368 | 0.1039 | 14.56% | 35.1 | yes |
| 2026-10-16 | 30 | 119 | -0.00570 | 0.0504 | -0.113 | +0.0437 | 0.1348 | 14.34% | 25.9 | yes |
| 2026-10-30 | 44 | 203 | -0.00766 | 0.0621 | -0.085 | +0.0557 | 0.1502 | 14.64% | 15.8 | yes |
| 2026-11-30 | 75 | 235 | -0.01313 | 0.0823 | -0.128 | +0.0665 | 0.1938 | 14.70% | 12.2 | yes |
| 2026-12-31 | 106 | 133 | -0.01730 | 0.0996 | -0.105 | +0.0847 | 0.2162 | 15.20% | 5.4 | yes |
| 2027-01-29 | 135 | 165 | -0.02355 | 0.1151 | -0.129 | +0.0914 | 0.2522 | 15.32% | 9.8 | yes |
| 2027-03-19 | 184 | 112 | -0.03821 | 0.1410 | -0.144 | +0.1046 | 0.3277 | 15.69% | 11.6 | yes |
| 2027-06-17 | 274 | 136 | -0.06572 | 0.1754 | -0.162 | +0.1336 | 0.4487 | 16.41% | 19.6 | yes |
| 2027-09-17 | 366 | 162 | -0.08076 | 0.1975 | -0.138 | +0.1768 | 0.4989 | 16.89% | 25.7 | yes |
| 2028-01-21 | 492 | 181 | -0.10416 | 0.2251 | -0.100 | +0.2323 | 0.5733 | 17.30% | 28.8 | yes |

Full precision, plus wing slopes and diagnostics, is in
[`outputs/svi_params.csv`](outputs/svi_params.csv).

**Fit quality.** Median RMSE across slices is **22.7 vol basis points**
(mean 20.8, worst 35.1). For context, the bid/ask spread on a
...
SVI: it compresses 1,679 quotes into 60 numbers with almost no
information loss.
...
Every one of the 12 fitted slices slopes downward: a 10% out-of-the-money put is quoted between 4.5 and 20.6 vol points above the 10% out-of-the-money call on the same expiry. This is the persistent equity-index downside skew, and it is the single largest departure from Black-Scholes on the whole surface.

| Expiry | Days | ATM IV | Skew: IV(−10%) − IV(+10%) | ATM total variance |
|---|---:|---:|---:|---:|
| 2026-09-23 | 7 | 14.75% | +20.57 | 0.00042 |
| 2026-09-25 | 9 | 14.91% | +14.22 | 0.00055 |
| 2026-10-02 | 16 | 14.56% | +12.67 | 0.00093 |
| 2026-10-16 | 30 | 14.34% | +12.03 | 0.00169 |
| 2026-10-30 | 44 | 14.64% | +11.06 | 0.00259 |
| 2026-11-30 | 75 | 14.70% | +10.20 | 0.00444 |
| 2026-12-31 | 106 | 15.20% | +9.20 | 0.00671 |
| 2027-01-29 | 135 | 15.32% | +8.57 | 0.00868 |
| 2027-03-19 | 184 | 15.69% | +7.45 | 0.01242 |
| 2027-06-17 | 274 | 16.41% | +6.14 | 0.02021 |
| 2027-09-17 | 366 | 16.89% | +5.36 | 0.02861 |
| 2028-01-21 | 492 | 17.30% | +4.50 | 0.04034 |
...
**+4.50** to **+20.57** vol points and is **falling** with maturity.
...
**A note on reading `rho`.** It is tempting to treat `rho` alone as the skew, and on this surface that would mislead: the fitted `rho` averages only -0.15, yet the smiles are steeply downward-sloping. Raw SVI has two ways to tilt a slice over the quoted range — rotate it with `rho`, or slide its vertex sideways with `m` — and here the fit mostly used `m` (mean +0.087, i.e. the minimum of the smile sits *above* the forward, leaving the traded strikes on the downward-sloping left branch). The two parameters are only weakly separated by data confined to one side of the vertex, which is exactly why the skew is measured here as an IV difference between two strikes rather than read off a parameter. The curve is well determined even where the parameters are not.
...
ATM implied vol runs from **14.75%** at 7 days to
**17.30%** at 492 days, and is **rising** across the term
structure.

ATM **total variance** `w = σ²T` rises monotonically from 0.00042
to 0.04034. That monotonicity is not cosmetic — it is
...
* **Across strikes**, at the 7-day expiry, fitted IV moves
  20.57 vol points between k = −0.10 and k = +0.10. At
  492 days it moves 4.50.
* **Across maturities**, ATM vol moves 2.55 vol points from the
  front slice to the back.
* **Total range** of fitted ATM vol across the surface: 14.34% to
  17.30%.
...
Take the 184-day expiry (2027-03-19) and price a put struck at 90% of the
forward — a standard portfolio hedge:

| | Volatility | Put price |
|---|---:|---:|
| Black-Scholes with the ATM vol | 15.69% | 7.31 |
| Fitted SVI vol at that strike | 20.37% | 13.98 |
| **Difference** | **+4.68 vol pts** | **+6.67 (+91.3%)** |
