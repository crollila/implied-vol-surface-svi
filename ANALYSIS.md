...
2026-09-11 19:30 UTC. Every figure in this document comes from that run;
...
| Underlying | **SPY** |
| Spot | 765.12 |
| As of | 2026-09-11 19:30 UTC |
| Risk-free rate | 4.00% (continuous) |
| Forward source | put_call_parity (12) |
| Price source | 1,460 bid/ask mid (100%), 4 last trade (0%) |
| Expiry slices fitted | **12** (7–497 days) |
| Clean surface points | **1,464** |
| Median fit RMSE | **13.0 vol bps** |

### Where the prices came from

Most points come from live two-sided markets (1,460 of 1,464), with the last-trade fallback filling in strikes that were momentarily unquoted.

### From raw chain to clean surface

The listed chain contained **9,125** contracts. Filtering leaves
**1,464** usable points (16.0%):

| Stage | Contracts remaining | Why |
|---|---:|---|
| Raw chain | 9,125 | every listed contract |
| Valid strike | 9,125 | drop malformed rows |
| Has a usable price | 8,176 | live two-sided mid, else a same-session last trade above the minimum premium |
| Inside the expiry window | 7,106 | 7–550 days |
...
| Inside the hard moneyness cap | 3,741 | \|k\| within the absolute limit |
| Non-negligible vega | 3,741 | price actually responds to volatility |
| Within 4 standard deviations | 2,939 | maturity-scaled wing cutoff |
| Not a local outlier | 2,869 | robust distance from the local smile |
| In one of the fitted slices | 1,464 | slice has enough points on both wings, and is one of the 12 expiries kept from the 22 that qualified |

That attrition is the honest part of the exercise: only 16.0% of the listed chain
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|:--:|
| 2026-09-18 | 7 | 71 | -0.00142 | 0.0214 | -0.802 | -0.0519 | 0.1109 | 12.73% | 43.8 | **no** |
| 2026-09-30 | 19 | 129 | -0.00199 | 0.0311 | -0.049 | +0.0329 | 0.0788 | 11.75% | 22.6 | yes |
| 2026-10-09 | 28 | 119 | -0.00413 | 0.0440 | -0.070 | +0.0379 | 0.1120 | 12.44% | 15.9 | yes |
| 2026-10-23 | 42 | 116 | -0.00726 | 0.0585 | -0.093 | +0.0442 | 0.1465 | 12.98% | 10.6 | yes |
| 2026-11-20 | 70 | 62 | -0.01356 | 0.0822 | -0.110 | +0.0579 | 0.1959 | 13.97% | 6.2 | yes |
| 2026-12-18 | 98 | 78 | -0.01748 | 0.0962 | -0.151 | +0.0621 | 0.2220 | 14.43% | 5.4 | yes |
| 2026-12-31 | 111 | 136 | -0.02025 | 0.1036 | -0.112 | +0.0779 | 0.2361 | 14.52% | 2.8 | yes |
| 2027-01-29 | 140 | 163 | -0.02765 | 0.1194 | -0.131 | +0.0858 | 0.2776 | 14.80% | 8.9 | yes |
| 2027-03-19 | 189 | 110 | -0.04231 | 0.1444 | -0.139 | +0.1006 | 0.3488 | 15.31% | 8.1 | yes |
| 2027-06-17 | 279 | 135 | -0.06482 | 0.1753 | -0.144 | +0.1360 | 0.4430 | 16.11% | 15.3 | yes |
| 2027-09-17 | 371 | 161 | -0.08328 | 0.1992 | -0.128 | +0.1771 | 0.5077 | 16.70% | 22.5 | yes |
| 2028-01-21 | 497 | 184 | -0.10959 | 0.2296 | -0.100 | +0.2278 | 0.5870 | 17.18% | 28.4 | yes |
...
(mean 15.9, worst 43.8). For context, the bid/ask spread on a
...
SVI: it compresses 1,464 quotes into 60 numbers with almost no
information loss.
...
Every one of the 12 fitted slices slopes downward: a 10% out-of-the-money put is quoted between 4.4 and 31.9 vol points above the 10% out-of-the-money call on the same expiry. This is the persistent equity-index downside skew, and it is the single largest departure from Black-Scholes on the whole surface.

| Expiry | Days | ATM IV | Skew: IV(−10%) − IV(+10%) | ATM total variance |
|---|---:|---:|---:|---:|
| 2026-09-18 | 7 | 12.73% | +31.89 | 0.00031 |
| 2026-09-30 | 19 | 11.75% | +9.36 | 0.00072 |
| 2026-10-09 | 28 | 12.44% | +10.06 | 0.00119 |
| 2026-10-23 | 42 | 12.98% | +10.14 | 0.00194 |
| 2026-11-20 | 70 | 13.97% | +9.63 | 0.00374 |
| 2026-12-18 | 98 | 14.43% | +8.92 | 0.00559 |
| 2026-12-31 | 111 | 14.52% | +8.66 | 0.00641 |
| 2027-01-29 | 140 | 14.80% | +8.08 | 0.00840 |
| 2027-03-19 | 189 | 15.31% | +7.08 | 0.01214 |
| 2027-06-17 | 279 | 16.11% | +5.99 | 0.01985 |
| 2027-09-17 | 371 | 16.70% | +5.23 | 0.02834 |
| 2028-01-21 | 497 | 17.18% | +4.44 | 0.04020 |
...
**+4.44** to **+31.89** vol points and is **falling** with maturity.
...
ATM implied vol runs from **12.73%** at 7 days to
**17.18%** at 497 days, and is **rising** across the term
structure.

ATM **total variance** `w = σ²T` rises monotonically from 0.00031
to 0.04020. That monotonicity is not cosmetic — it is
...
* **Across strikes**, at the 7-day expiry, fitted IV moves
  31.89 vol points between k = −0.10 and k = +0.10. At
  497 days it moves 4.44.
* **Across maturities**, ATM vol moves 4.45 vol points from the
  front slice to the back.
* **Total range** of fitted ATM vol across the surface: 11.75% to
  17.18%.
...
Take the 189-day expiry (2027-03-19) and price a put struck at 90% of the
forward — a standard portfolio hedge:

| | Volatility | Put price |
|---|---:|---:|
| Black-Scholes with the ATM vol | 15.31% | 7.19 |
| Fitted SVI vol at that strike | 19.81% | 13.75 |
| **Difference** | **+4.50 vol pts** | **+6.55 (+91.1%)** |
...
**1 of 12 slices fail the butterfly check** even after the penalised refit (most negative `g(k)` = 9.28e-05). These are flagged in `outputs/svi_params.csv` and marked on the smile plots; they should not be used to price anything without further constraint.
...
Across all 1,464 points, the model-minus-market residual has mean
**-2.3 vol bps** and standard deviation **18.9 vol bps**; the median
