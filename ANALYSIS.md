...
2026-09-24 20:20 UTC. Every figure in this document comes from that run;
...
| Underlying | **SPY** |
| Spot | 767.27 |
| As of | 2026-09-24 20:20 UTC |
| Risk-free rate | 4.00% (continuous) |
| Forward source | put_call_parity (12) |
| Price source | 1,300 bid/ask mid (100%), 3 last trade (0%) |
| Expiry slices fitted | **12** (8–484 days) |
| Clean surface points | **1,303** |
| Median fit RMSE | **10.2 vol bps** |

### Where the prices came from

Most points come from live two-sided markets (1,300 of 1,303), with the last-trade fallback filling in strikes that were momentarily unquoted.

### From raw chain to clean surface

The listed chain contained **9,679** contracts. Filtering leaves
**1,303** usable points (13.5%):

| Stage | Contracts remaining | Why |
|---|---:|---|
| Raw chain | 9,679 | every listed contract |
| Valid strike | 9,679 | drop malformed rows |
| Has a usable price | 8,192 | live two-sided mid, else a same-session last trade above the minimum premium |
| Inside the expiry window | 6,062 | 7–550 days |
| Out-of-the-money, monotone in strike | 3,388 | keep the OTM side; discard prints that break monotonicity of price in strike |
| Implied vol solved | 3,388 | Brent/Newton inversion converged |
| Plausible vol level | 3,388 | 1% <= IV <= 300% |
...
| Not a local outlier | 2,636 | robust distance from the local smile |
| In one of the fitted slices | 1,303 | slice has enough points on both wings, and is one of the 12 expiries kept from the 21 that qualified |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|:--:|
| 2026-10-02 | 8 | 98 | -0.00117 | 0.0233 | +0.218 | +0.0313 | 0.0639 | 12.18% | 12.7 | yes |
| 2026-10-06 | 12 | 22 | -0.00159 | 0.0262 | +0.085 | +0.0267 | 0.0747 | 11.41% | 12.9 | yes |
| 2026-10-16 | 22 | 120 | -0.00394 | 0.0415 | +0.003 | +0.0343 | 0.1118 | 12.31% | 10.5 | yes |
| 2026-10-23 | 29 | 121 | -0.00563 | 0.0489 | -0.052 | +0.0341 | 0.1343 | 12.49% | 9.8 | yes |
| 2026-11-20 | 57 | 57 | -0.01443 | 0.0784 | -0.108 | +0.0448 | 0.2119 | 13.71% | 7.1 | yes |
| 2026-12-18 | 85 | 72 | -0.01677 | 0.0914 | -0.150 | +0.0504 | 0.2211 | 14.13% | 9.2 | yes |
| 2027-01-15 | 113 | 86 | -0.02200 | 0.1054 | -0.171 | +0.0558 | 0.2535 | 14.32% | 9.4 | yes |
| 2027-02-26 | 155 | 134 | -0.04536 | 0.1488 | -0.026 | +0.1158 | 0.3456 | 14.83% | 8.9 | yes |
| 2027-03-31 | 188 | 118 | -0.05210 | 0.1529 | -0.125 | +0.0986 | 0.3947 | 15.25% | 3.1 | yes |
| 2027-06-17 | 266 | 132 | -0.07086 | 0.1791 | -0.137 | +0.1262 | 0.4658 | 16.00% | 14.1 | yes |
| 2027-09-17 | 358 | 161 | -0.09657 | 0.2082 | -0.124 | +0.1642 | 0.5504 | 16.67% | 21.2 | yes |
| 2028-01-21 | 484 | 182 | -0.12038 | 0.2374 | -0.085 | +0.2215 | 0.6145 | 17.19% | 25.6 | yes |

Full precision, plus wing slopes and diagnostics, is in
[`outputs/svi_params.csv`](outputs/svi_params.csv).

**Fit quality.** Median RMSE across slices is **10.2 vol basis points**
(mean 12.0, worst 25.6). For context, the bid/ask spread on a
...
SVI: it compresses 1,303 quotes into 60 numbers with almost no
information loss.
...
Every one of the 12 fitted slices slopes downward: a 10% out-of-the-money put is quoted between 1.8 and 9.0 vol points above the 10% out-of-the-money call on the same expiry. This is the persistent equity-index downside skew, and it is the single largest departure from Black-Scholes on the whole surface.

| Expiry | Days | ATM IV | Skew: IV(−10%) − IV(+10%) | ATM total variance |
|---|---:|---:|---:|---:|
| 2026-10-02 | 8 | 12.18% | +1.78 | 0.00032 |
| 2026-10-06 | 12 | 11.41% | +4.54 | 0.00043 |
| 2026-10-16 | 22 | 12.31% | +7.89 | 0.00091 |
| 2026-10-23 | 29 | 12.49% | +8.57 | 0.00124 |
| 2026-11-20 | 57 | 13.71% | +8.99 | 0.00293 |
| 2026-12-18 | 85 | 14.13% | +8.60 | 0.00465 |
| 2027-01-15 | 113 | 14.32% | +8.01 | 0.00635 |
| 2027-02-26 | 155 | 14.83% | +7.41 | 0.00934 |
| 2027-03-31 | 188 | 15.25% | +6.70 | 0.01198 |
| 2027-06-17 | 266 | 16.00% | +5.87 | 0.01866 |
| 2027-09-17 | 358 | 16.67% | +5.08 | 0.02725 |
| 2028-01-21 | 484 | 17.19% | +4.33 | 0.03917 |
...
**+1.78** to **+8.99** vol points and is **broadly flat** with maturity.
...
**A note on reading `rho`.** It is tempting to treat `rho` alone as the skew, and on this surface that would mislead: the fitted `rho` averages only -0.06, yet the smiles are steeply downward-sloping. Raw SVI has two ways to tilt a slice over the quoted range — rotate it with `rho`, or slide its vertex sideways with `m` — and here the fit mostly used `m` (mean +0.084, i.e. the minimum of the smile sits *above* the forward, leaving the traded strikes on the downward-sloping left branch). The two parameters are only weakly separated by data confined to one side of the vertex, which is exactly why the skew is measured here as an IV difference between two strikes rather than read off a parameter. The curve is well determined even where the parameters are not.
...
ATM implied vol runs from **12.18%** at 8 days to
**17.19%** at 484 days, and is **rising** across the term
structure.

ATM **total variance** `w = σ²T` rises monotonically from 0.00032
to 0.03917. That monotonicity is not cosmetic — it is
...
* **Across strikes**, at the 8-day expiry, fitted IV moves
  1.78 vol points between k = −0.10 and k = +0.10. At
  484 days it moves 4.33.
* **Across maturities**, ATM vol moves 5.01 vol points from the
  front slice to the back.
* **Total range** of fitted ATM vol across the surface: 11.41% to
  17.19%.
...
Take the 188-day expiry (2027-03-31) and price a put struck at 90% of the
forward — a standard portfolio hedge:

| | Volatility | Put price |
|---|---:|---:|
| Black-Scholes with the ATM vol | 15.25% | 7.10 |
| Fitted SVI vol at that strike | 19.56% | 13.35 |
| **Difference** | **+4.32 vol pts** | **+6.25 (+88.1%)** |

Using the ATM vol for an out-of-the-money put misprices it by **88%**. That is
