...
2026-09-23 20:07 UTC. Every figure in this document comes from that run;
...
| Underlying | **SPY** |
| Spot | 767.83 |
| As of | 2026-09-23 20:07 UTC |
| Risk-free rate | 4.00% (continuous) |
| Forward source | put_call_parity (12) |
| Price source | 1,369 bid/ask mid (100%), 3 last trade (0%) |
| Expiry slices fitted | **12** (8–485 days) |
| Clean surface points | **1,372** |
| Median fit RMSE | **11.4 vol bps** |

### Where the prices came from

Most points come from live two-sided markets (1,369 of 1,372), with the last-trade fallback filling in strikes that were momentarily unquoted.

### From raw chain to clean surface

The listed chain contained **9,956** contracts. Filtering leaves
**1,372** usable points (13.8%):

| Stage | Contracts remaining | Why |
|---|---:|---|
| Raw chain | 9,956 | every listed contract |
| Valid strike | 9,956 | drop malformed rows |
| Has a usable price | 8,368 | live two-sided mid, else a same-session last trade above the minimum premium |
| Inside the expiry window | 6,171 | 7–550 days |
| Out-of-the-money, monotone in strike | 3,382 | keep the OTM side; discard prints that break monotonicity of price in strike |
| Implied vol solved | 3,382 | Brent/Newton inversion converged |
| Plausible vol level | 3,382 | 1% <= IV <= 300% |
| Inside the hard moneyness cap | 3,296 | \|k\| within the absolute limit |
| Non-negligible vega | 3,296 | price actually responds to volatility |
| Within 4 standard deviations | 2,680 | maturity-scaled wing cutoff |
| Not a local outlier | 2,635 | robust distance from the local smile |
| In one of the fitted slices | 1,372 | slice has enough points on both wings, and is one of the 12 expiries kept from the 22 that qualified |

That attrition is the honest part of the exercise: only 13.8% of the listed chain
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|:--:|
| 2026-10-01 | 8 | 79 | -0.00103 | 0.0212 | +0.136 | +0.0258 | 0.0601 | 11.28% | 11.8 | yes |
| 2026-10-05 | 12 | 82 | -0.00155 | 0.0252 | +0.057 | +0.0254 | 0.0748 | 11.02% | 12.2 | yes |
| 2026-10-09 | 16 | 106 | -0.00218 | 0.0321 | +0.084 | +0.0342 | 0.0828 | 11.70% | 10.1 | yes |
| 2026-10-23 | 30 | 121 | -0.00561 | 0.0499 | -0.012 | +0.0402 | 0.1310 | 12.34% | 8.8 | yes |
| 2026-11-20 | 58 | 57 | -0.01440 | 0.0780 | -0.100 | +0.0476 | 0.2123 | 13.61% | 8.6 | yes |
| 2026-12-18 | 86 | 72 | -0.01735 | 0.0925 | -0.127 | +0.0557 | 0.2241 | 14.06% | 9.8 | yes |
| 2026-12-31 | 99 | 124 | -0.02101 | 0.1009 | -0.087 | +0.0727 | 0.2457 | 14.21% | 5.3 | yes |
| 2027-01-29 | 128 | 155 | -0.02805 | 0.1172 | -0.101 | +0.0830 | 0.2819 | 14.50% | 12.8 | yes |
| 2027-03-19 | 177 | 105 | -0.04680 | 0.1470 | -0.126 | +0.0911 | 0.3707 | 15.06% | 10.9 | yes |
| 2027-06-17 | 267 | 132 | -0.06844 | 0.1771 | -0.126 | +0.1316 | 0.4572 | 16.00% | 14.6 | yes |
| 2027-09-17 | 359 | 158 | -0.09840 | 0.2086 | -0.121 | +0.1661 | 0.5584 | 16.67% | 21.0 | yes |
| 2028-01-21 | 485 | 181 | -0.11512 | 0.2342 | -0.077 | +0.2271 | 0.6001 | 17.18% | 25.7 | yes |

Full precision, plus wing slopes and diagnostics, is in
[`outputs/svi_params.csv`](outputs/svi_params.csv).

**Fit quality.** Median RMSE across slices is **11.4 vol basis points**
(mean 12.6, worst 25.7). For context, the bid/ask spread on a
...
SVI: it compresses 1,372 quotes into 60 numbers with almost no
information loss.
...
Every one of the 12 fitted slices slopes downward: a 10% out-of-the-money put is quoted between 3.2 and 9.0 vol points above the 10% out-of-the-money call on the same expiry. This is the persistent equity-index downside skew, and it is the single largest departure from Black-Scholes on the whole surface.

| Expiry | Days | ATM IV | Skew: IV(−10%) − IV(+10%) | ATM total variance |
|---|---:|---:|---:|---:|
| 2026-10-01 | 8 | 11.28% | +3.25 | 0.00028 |
| 2026-10-05 | 12 | 11.02% | +5.10 | 0.00040 |
| 2026-10-09 | 16 | 11.70% | +6.16 | 0.00060 |
| 2026-10-23 | 30 | 12.34% | +8.51 | 0.00125 |
| 2026-11-20 | 58 | 13.61% | +8.98 | 0.00294 |
| 2026-12-18 | 86 | 14.06% | +8.56 | 0.00466 |
| 2026-12-31 | 99 | 14.21% | +8.30 | 0.00548 |
| 2027-01-29 | 128 | 14.50% | +7.86 | 0.00738 |
| 2027-03-19 | 177 | 15.06% | +6.82 | 0.01100 |
| 2027-06-17 | 267 | 16.00% | +5.84 | 0.01872 |
| 2027-09-17 | 359 | 16.67% | +5.02 | 0.02733 |
| 2028-01-21 | 485 | 17.18% | +4.33 | 0.03920 |
...
**+3.25** to **+8.98** vol points and is **broadly flat** with maturity.
...
**A note on reading `rho`.** It is tempting to treat `rho` alone as the skew, and on this surface that would mislead: the fitted `rho` averages only -0.05, yet the smiles are steeply downward-sloping. Raw SVI has two ways to tilt a slice over the quoted range — rotate it with `rho`, or slide its vertex sideways with `m` — and here the fit mostly used `m` (mean +0.083, i.e. the minimum of the smile sits *above* the forward, leaving the traded strikes on the downward-sloping left branch). The two parameters are only weakly separated by data confined to one side of the vertex, which is exactly why the skew is measured here as an IV difference between two strikes rather than read off a parameter. The curve is well determined even where the parameters are not.
...
ATM implied vol runs from **11.28%** at 8 days to
**17.18%** at 485 days, and is **rising** across the term
structure.

ATM **total variance** `w = σ²T` rises monotonically from 0.00028
to 0.03920. That monotonicity is not cosmetic — it is
...
* **Across strikes**, at the 8-day expiry, fitted IV moves
  3.25 vol points between k = −0.10 and k = +0.10. At
  485 days it moves 4.33.
* **Across maturities**, ATM vol moves 5.90 vol points from the
  front slice to the back.
* **Total range** of fitted ATM vol across the surface: 11.02% to
  17.18%.
...
Take the 177-day expiry (2027-03-19) and price a put struck at 90% of the
forward — a standard portfolio hedge:

| | Volatility | Put price |
|---|---:|---:|
| Black-Scholes with the ATM vol | 15.06% | 6.29 |
| Fitted SVI vol at that strike | 19.54% | 12.41 |
| **Difference** | **+4.47 vol pts** | **+6.12 (+97.3%)** |

Using the ATM vol for an out-of-the-money put misprices it by **97%**. That is
...
Across all 1,372 points, the model-minus-market residual has mean
**-1.6 vol bps** and standard deviation **15.0 vol bps**; the median
